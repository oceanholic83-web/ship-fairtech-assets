...
(function () {
  ...
  const CUSTOMS_PORTS = {
    수도권충청: {
      ...
      label: '수도권·충청',
      items: [
        { name: '인천세관', role: '인천본부', url: 'https://www.customs.go.kr/incheon/main.do', portKey: '인천항' },
        { name: '평택세관', role: '직할', url: 'https://www.customs.go.kr/pyeongtaek/main.do', portKey: '평택·당진항' },
    ...
    영남: {
      ...
      label: '영남',
      items: [
        { name: '부산세관', role: '부산본부', url: 'https://www.customs.go.kr/busan/main.do', portKey: '부산항' },
